...
def render_manim_subtitles(song_json: str, output_webm: str) -> bool:
    ...
    cmd = [
        "manim",
        "-qh",               # 🚨 1080p High Quality (matches background)
        "--format=mov",      # 🚨 .mov preserves alpha channels better in MoviePy
        "--transparent",     
...
def composite_with_moviepy(background_mp4: str, overlay_webm: str, output_mp4: str, audio_mp3: str) -> bool:
    try:
        ...
        # 🚨 Force Luma Masking: forces pure black pixels to be transparent
...
if __name__ == "__main__":
    ...
    manim_ok = render_manim_subtitles(JSON_PATH, "manim_overlay.webm")
